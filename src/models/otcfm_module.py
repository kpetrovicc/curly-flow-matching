...
class OTCFMModule(LightningModule):
    ...
    def training_step(
        ...
        if (self.current_epoch+1)%100==0:
            ...
            with torch.no_grad():
                ...
                torch.save(traj, os.path.join('traj_otcfm', f"traj_{self.current_epoch}.pt"))
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        # plot_velocity_field(self.net, self.datamodule.train_x, self.device, self.current_epoch, save_dir='otcfmfield')
...
if __name__ == "__main__":
    _ = OTCFMModule(None, None, None, None)
